...
use super::value::{InterpretedFunctionData, RcValue, Value};
use super::{ExecutionEngine, ExecutionResult};

use crate::stdlib::{get_stdlib, types};
...
impl ExecutionContext {
    ...
    fn handle_pop_object_value(
        ...
        let popped_value = match *object_value {
            ...
            _ => unimplemented!("Handle methods of non-object values!"),
        };
